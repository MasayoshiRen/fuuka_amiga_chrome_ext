...
como também fazer uma extensão que possa ser divertida que os usuários possam gostar.
Planejada para ser atualizada periodicamente.
...
1.0.0 - Finished Fuukalculadora (to be polished)
1.1.0 - Changed code to suit the security measures
1.1.1 - Organizing files
1.2.0 - Begun coding page 2 (and extension 21) and 3
2.0.0 - Finished música page (to be polished)
2.1.0 - Optimized code in page3.html and music.js
